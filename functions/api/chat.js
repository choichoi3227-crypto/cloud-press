...
업그레이드 없이 영구 무료로 사용하실 수 있습니다! 업그레이드가 필요하시면 [요금 페이지](/pricing)를 확인해주세요.`
      },
      {
...
결제는 [결제 페이지](/payment)에서 바로 진행하실 수 있습니다.`
      },
      {
...
Cloudflare DNS를 사용 중이라면 [DNS 관리](/dns)에서 직접 설정 가능합니다.`
      },
      {
...
탈퇴를 원하신다면: [계정 설정](/account) → 위험 구역 → 계정 삭제`
      }
    ]
  },
...
[기능 소개 페이지](/features)에서 더 자세히 확인하세요.`,
    children: [
      {
...
[도메인 관리](/domains)에서 모든 도메인을 한눈에 확인하세요.`,
    children: [
      {
